...
DEFAULT_SCALING_METHOD = "standardize"
...
class DatasetPreprocessor:
    ...
    def handle_missing_values(self):
        ...
        if null_percentage <= MISSING_VALUE_THRESHOLD:
...
class DatasetVisualizer:
    """
    Handles dataset visualization including pairplot and correlation comparison
    """

    def __init__(self, dataframe, target_column):
        """
        Initializes visualizer with dataset and target column
        """
        self.dataframe = dataframe
        self.target_column = target_column
    ...
    def pairplot(self):
        """
        Generates pairplot showing relationships between all variables
    ...
    def correlation_heatmap(self):
        """
        Computes and displays correlation matrix heatmap
        showing correlation between each column and every other column
        including the target column
        """
        ...
        # Title for clarity
        plt.title(
            "Correlation Matrix (Feature vs Feature and Feature vs Target)",
            fontsize=14
        )
    ...
    def target_correlation(self):
        """
        Displays correlation of each feature specifically with target column
